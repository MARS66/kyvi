 ...
 * @Description: 
 * @Author: Kevin
 * @Date: 2024-09-06 16:12:51
 * @LastEditors: Kevin
 * @LastEditTime: 2024-09-19 10:55:11
 */
...
export function createProjectGroup(name: any) {
  return request.post('/project/group', name)
}
...
export function getShareUrl(id: number) {
  return `${window.location.origin}/preview?projectId=${id}`
}
