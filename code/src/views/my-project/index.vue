  ...
  <div class="my-project">
    <div class="project-main">
      ...
      <div class="project-screen-list">
          <project-list :group="selectedGroup" :selectedGroupId="selectedGroupId" />
      </div>
    </div>
  </div>
</template>
...
import { IconPlus, IconEdit, IconDelete } from '@/icons'
...
const confirmDeleteGroup = (group: ProjectGroup) => {
  const confirmDia = DialogPlugin({
        ...
        width: '300px',
        placement:'center',
        body: `${group.name}删除后无法恢复，该分组中的可视化应用将全部彻底删除，确认删除？`,
        cancelBtn: '取消',
        confirmBtn: '确定',
        onConfirm: async () => {
          try {
